...
import { catergories } from "../navbar/Categories";
...
const RentModal = () => {
    ...
    const setCustomeValue = (id: string, value: any) => {
        console.log("SET CUSTOM VALUE", id, value)
        setValue(id, value), {
            shouldValidate: true,
            shouldDirty: true,
            shouldTouch: true
    ...
    let bodyContent = (
        <div className="flex flex-col gap-8">
            <Heading
                ...
                subtitle="Start by selecting a category"
            />
        ...
        bodyContent = (
            <div className="flex flex-col gap-8">
               <Heading 
                    ...
                    subtitle="What ammenities do you provide" 
                />
                <Counter
                    title="Guets"
                    subtitle="How many guests can your place accommodate?"
                    value={guestCount}
                    onChnage={(value) => setCustomeValue('guestCount', value)}
                />
                <hr></hr>
                <Counter
                    title="Rooms"
                    ...
                    value={roomCount}
                    onChnage={(value) => setCustomeValue('roomCount', value)}
                />
                <hr></hr>
                <Counter
                    title="Bathrooms"
                    ...
                    value={bathroomCount}
                    onChnage={(value) => setCustomeValue('bathroomCount', value)}
                />
            </div>
        );   
    }
